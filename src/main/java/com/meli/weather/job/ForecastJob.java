...
public class ForecastJob {
    ...
    public ForecastJob(FindJobControlByTypeInteractor findJobControlByType, WeatherForecastJobInteractor weatherForecastJob,
                       CreateJobControlInteractor createJobControl, UpdateJobControlInteractor updateJobControl,
                       ClearWeatherForecastInteractor clearWeatherForecast,
                       @Value("${forecast.errorMargin}") Double errorMargin,
                       @Value("${forecast.daysPerYear}") Integer daysPerYear,
                       @Value("${forecast.numberOfYears}") Integer numberOfYears) {
    ...
    private void executeJob(JobControl jobControl) {
        try {
